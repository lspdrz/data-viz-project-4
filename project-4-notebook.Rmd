...
Here we use the cumulative distribution function to select the counties with a poverty ratio in the top 10% and view their powerball sales from 2011-2014
```{r}
...
Here we use the percent_rank function to only view the poorest 15% counties. Then we use the lag function to determine the slope for each year's powerball sales.
```{r}
